...
async function loadPatientPortal(){
  ...
  try{
    ...
    patientOrders.innerHTML = timeline(d.orders, 'No current orders shared in this prototype.');
    patientLabs.innerHTML = timeline(d.labs, 'No lab results shared in this prototype.');
    patientImaging.innerHTML = timeline(d.imaging, 'No imaging updates shared in this prototype.');
    patientNotes.innerHTML = timeline(d.notes, 'No clinical notes shared in this prototype.');
  }catch(e){
    clearPToken();
    location.href = 'patient-login.html';
  }
